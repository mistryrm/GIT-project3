...
function timeLine(){
    ...
    d3.json(met_url).then(function(met_data){
        ...
        d3.json(map_url).then(function(map_data){
            ...
            console.log( "objectSeleted" , objectSeleted );
